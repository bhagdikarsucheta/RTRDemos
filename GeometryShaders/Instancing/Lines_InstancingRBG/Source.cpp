...
void initialize()
{
	...
	const GLchar *geometryShaderSource =
		...
		"{"\
			"fColor = color[0];"\
			"gl_Position = u_mvp_matrix * (gl_in[0].gl_Position )+vec4(-0.1,0.1,0.0,0.0);"\
			"EmitVertex();"\
			"fColor.a=0.7f;"\
			"gl_Position = u_mvp_matrix * (gl_in[0].gl_Position )+vec4(0.5,0.1,0.0,0.0);"\
			"EmitVertex();"\
	...
	//float points[] = {
	//-0.45f,  0.45f, 1.0f, 1.0f, 1.0f, // Red point
	// 0.45f,  0.45f, 1.0f, 1.0f, 1.0f, // Green point
	// 0.45f, -0.45f, 1.0f, 1.0f, 1.0f, // Blue point
	//-0.45f, -0.45f, 1.0f, 1.0f, 0.0f, // Yellow point
	//};
	float points[] = {
	-0.45f,  0.45f, 1.0f, 1.0f, 1.0f,0.0f, // Red point
	 0.45f,  0.45f, 1.0f, 1.0f, 1.0f,0.0f, // Green point
	 0.45f, -0.45f, 1.0f, 1.0f, 1.0f,0.0f,// Blue point
	-0.45f, -0.45f, 1.0f, 1.0f, 1.0f,0.0f, // Yellow point
	};
	...
	glVertexAttribPointer(VDG_ATTRIBUTE_VERTEX, 2, GL_FLOAT, GL_FALSE, 6 * sizeof(float), 0);
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(points), points, GL_STATIC_DRAW);
	glVertexAttribPointer(VDG_ATTRIBUTE_COLOR, 4, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)(2 * sizeof(float)));
...
void display(void)
{
	...
	glUniformMatrix4fv(gMVPUniform2, 1, GL_FALSE, modelviewProjectionMatrix);
	glLineWidth(2.0f);
